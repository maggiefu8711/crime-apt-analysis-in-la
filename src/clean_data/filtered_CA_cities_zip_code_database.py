...
file_path = "data/raw/[Gov]zip_code_database.csv"
...
filtered_data = zip_code_data[
    (zip_code_data['state'] == 'CA') &
    (zip_code_data['primary_city'].isin(cities))
]
# print(filtered_data)
# exit()
filtered_data.to_csv(
    'data/processed/filtered_CA_cities_zip_code_database.csv',
    index=False
)
